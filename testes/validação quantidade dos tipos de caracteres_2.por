programa
{
	...
	enquanto(quantidade_caracteres == falso){
		...
		se (simbolo < minimo){
		    ...
		    letra_minuscula = 0
		    letra_maiuscula = 0
		}senao se(numeros < minimo){
		    quantidade_caracteres = falso
		    simbolo = 0
		    numeros = 0
		    letra_minuscula = 0
		    letra_maiuscula = 0
		}senao se(letra_minuscula < minimo){
		    quantidade_caracteres = falso
		    simbolo = 0
		    numeros = 0
		    letra_minuscula = 0
		    letra_maiuscula = 0
		}senao se(letra_maiuscula < minimo){
		    quantidade_caracteres = falso
		    simbolo = 0
		    numeros = 0
		    letra_minuscula = 0
 ...
 * @POSICAO-CURSOR = 773; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {ascii, 5, 9, 5}-{minimo, 5, 23, 6}-{simbolo, 5, 31, 7}-{numeros, 5, 44, 7}-{letra_minuscula, 5, 57, 15}-{letra_maiuscula, 5, 78, 15}-{senha, 6, 8, 5}-{a, 36, 19, 1}-{b, 37, 20, 1};
