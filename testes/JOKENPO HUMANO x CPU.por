 ...
 * @POSICAO-CURSOR = 6456; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {nomeA, 129, 11, 5}-{nomeB, 129, 18, 5}-{jogadaA, 129, 25, 7}-{jogadaB, 129, 34, 7}-{placarA, 130, 12, 7}-{placarB, 130, 21, 7}-{jogadaA_int, 130, 30, 11}-{jogadaB_int, 130, 43, 11};
